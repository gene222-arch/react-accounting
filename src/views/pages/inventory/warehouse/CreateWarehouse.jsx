...
const CreateWarehouse = ({ alert, warehouseProp }) => 
{
    ...
    const onSubmitCreateWarehouse = (e) => dispatch(WAREHOUSE.createWarehouse({
        ...warehouseState,
...
export default connect(mapStateToProps, null)(CreateWarehouse)
