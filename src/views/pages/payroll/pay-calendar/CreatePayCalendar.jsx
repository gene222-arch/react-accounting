...
const CreatePayCalendar = ({ alert, employeeProp, payCalendarProp }) => 
{
    ...
    const onSubmitCreatePayCalendar = () => dispatch(PAY_CALENDAR.createPayCalendar(payCalendarState));
...
export default connect(mapStateToProps, null)(CreatePayCalendar)