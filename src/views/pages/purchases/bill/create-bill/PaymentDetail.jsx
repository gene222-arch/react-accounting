    ...
    setTax}) => 
{
    ...
    const handleChangeCurrency = (e) => 
    {
        if (!items.length) {
            ...
            const findCurrency = currencyProp.currencies.find(currency => currency.id === id);
    ...
    const handleChangeDiscount = (e) => 
    {
        if (!items.length) {
            ...
            const findDiscount = discountProp.discounts.find(discount => discount.id === id);
    ...
    const handleChangeTax = (e) => 
    {
        if (!items.length) {
            ...
            const findTax = taxProp.taxes.find(tax => tax.id === id);
                        ...
                        <TableRow>
                            <TableCell align="right">
                                <FormControl fullWidth>
                                    ...
                                    >
                                        {
                                            taxProp.taxes.map(({ id, name }) => <MenuItem key={ id } value={ id }>{ name }</MenuItem>)
                                        }
                                    </Select>
                                </FormControl>  
                            </TableCell>
                        ...
                        <TableRow>
                            <TableCell align="right">
                                <FormControl fullWidth>
                                    ...
                                    >
                                        {
                                            discountProp.discounts.map(({ id, name }) => <MenuItem key={ id } value={ id }>{ name }</MenuItem>)
                                        }
                                    </Select>
                                </FormControl>                            
                            </TableCell>
