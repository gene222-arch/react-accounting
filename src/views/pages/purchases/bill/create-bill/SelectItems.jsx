...
const SelectItems = ({ alert, itemProp, items, setItems, paymentDetailState, setPaymentDetailState }) => 
{
    ...
    const updatePaymentDetails = () => 
    {
        ...
        let total = items.reduce((total, item) => total + parseFloat(item.amount), 0);
        total += parseFloat(paymentDetailState.total_taxes) - parseFloat(paymentDetailState.total_discounts);
