...
const CreateVendor = ({ alert, currencyProp, vendorProp }) => 
{
    ...
    const onSubmitCreateVendor = () => dispatch(VENDOR.createVendor(vendorState));
    ...
    return !isLoading && (
        <div>
            ...
            />
            <form onSubmit={ onSubmitCreateVendor }>
                <Card>
                    <CardContent>
                    ...
                    <CardActions>
                        <SaveCancelButtons 
                            isLoading={ isLoading }
                            cancelBtnCallback={ () => history.push(PATH.VENDOR) }
                            saveBtnCallback={ onSubmitCreateVendor }
                        />
                    </CardActions>
                </Card>
            </form>
