...
/** API */
import { findAsync } from '../../../../services/banking/account';
...
const UpdateAccount = ({ alert, currencyProp, accountProp, match }) => 
{
    ...
    const onLoadFetchAccount = async () => {
    ...
    const onSubmitUpdateAccount = () => dispatch(ACCOUNT.updateAccount({
        ...accountState,
    ...
    return !isLoading && (
        <div>
            ...
            />
            <form onSubmit={ onSubmitUpdateAccount }>
                <Card>
                    <CardContent>
                    ...
                    <CardActions>
                        <SaveCancelButtons 
                            ...
                            saveBtnCallback={ onSubmitUpdateAccount }
                        />
                    </CardActions>
                </Card>
            </form>
...
export default connect(mapStateToProps, null)(UpdateAccount)
