...
/** API */
import { findAsync } from '../../../../services/sales/customer'
...
const UpdateVendor = ({ alert, currencyProp, customerProp, match }) => 
{
    ...
    const onSubmitUpdateCustomer = () => dispatch(CUSTOMER.updateCustomer(customerState));
            ...
            <form onSubmit={ onSubmitUpdateCustomer }>
                <Card>
                    ...
                    <CardActions>
                        <SaveCancelButtons 
                            isLoading={ isLoading }
                            cancelBtnCallback={ () => history.push(PATH.CREATE_CUSTOMER) }
                            saveBtnCallback={ onSubmitUpdateCustomer }
                        />
                    </CardActions>
                </Card>
            </form>
