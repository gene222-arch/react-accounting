...
const SelectCustomer = ({ invoiceState, customerProp, handleChange, handleClickReselectCustomer, error }) => 
{
    const classes = selectCustomerUseStyles();

    let customer = customerProp.customers.find(({ id }) => id === invoiceState.customer_id);
                ...
                !customer && (
                    <Grid item xs={12} sm={12} md={12} lg={12}>
                        <FormControl error={ Boolean(error.customer_id) } fullWidth>
                            ...
                            <Select
                                value={ invoiceState.customer_id }
