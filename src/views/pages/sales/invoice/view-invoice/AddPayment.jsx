...
const AddPayment = ({ accountProp, currencyProp, paymentMethodProp, invoiceProp, invoiceAction, id }) => 
{
    const dispatch = useDispatch();

    const { error, isLoading } = invoiceProp;
    ...
    const addPayment = () => dispatch(invoiceAction.payment({
        ...addPaymentState,
        id
    }));
