...
const CreateEstimateInvoice = ({ alert, discountProp, taxProp, currencyProp, defaultSettingsProp, customerProp, estimateInvoiceProp }) => 
{
    ...
    const updatePaymentDetails = () => 
    {
        ...
        const total_discounts = (discount.rate / 100) * subTotal;
        const total_taxes = (tax.rate / 100) * subTotal; 
    ...
    const onSubmitCreateInvoice = () => {
        dispatch(ESTIMATE_INVOICE.createEstimateInvoice({
...
export default connect(mapStateToProps, null)(CreateEstimateInvoice)
