...
const CreateJournalEntry = ({ alert, chartOfAccountProp, journalEntryProp }) => 
{
    ...
    const columns = [
        ...
        { 
            ...
            render: row => row.debit?.toFixed(2) ?? (0).toFixed(2)
        },
        { 
            title: 'Credit', 
            field: 'credit', 
            ...
            render: row => row.credit?.toFixed(2) ?? (0).toFixed(2) 
        }
    ];
    ...
    const onSubmitCreateJournalEntry = () => {
        ...
        if (!journalEntryDetails.length) {
            ...
            dispatch(JOURNAL_ENTRY.createJournalEntry({
                ...journalEntryState,
    ...
    return !chartOfAccountProp.isLoading && (
        <>
            ...
            />
            <form onSubmit={ onSubmitCreateJournalEntry }>
                <Grid container spacing={1}>
                    ...
                    <Grid item xs={12} sm={12} md={12} lg={12}>
                        <SaveCancelButtons
                            ...
                            saveBtnCallback={ onSubmitCreateJournalEntry }
                        />
                    </Grid>
                </Grid>
            </form>
...
export default connect(mapStateToProps, null)(CreateJournalEntry);
