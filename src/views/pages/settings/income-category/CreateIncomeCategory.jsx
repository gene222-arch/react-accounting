...
const CreateIncomeCategory = ({ alert, selectIncomeCategoryProp }) => 
{
    ...
    const onSubmitCreateIncomeCategory = () => dispatch(INCOME_CATEGORY.createIncomeCategory(incomeCategoryState));
    ...
    return !isLoading && (
        <div>
            ...
            />
            <form onSubmit={ onSubmitCreateIncomeCategory }>
                <Card>
                    <CardContent>
                    ...
                    <CardActions>
                        <SaveCancelButtons 
                            isLoading={ isLoading }
                            cancelBtnCallback={ () => history.push(PATH.INCOME_INCOME_CATEGORY) }
                            saveBtnCallback={ onSubmitCreateIncomeCategory }
                        />
                    </CardActions>
                </Card>
            </form>
...
export default connect(mapStateToProps, null)(CreateIncomeCategory)
