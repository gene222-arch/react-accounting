...
const CreateExpenseCategory = ({ alert, selectExpenseCategoryProp }) => 
{
    ...
    const onSubmitCreateExpenseCategory = () => dispatch(EXPENSE_CATEGORY.createExpenseCategory(expenseCategoryState));
    ...
    return !isLoading && (
        <div>
            ...
            />
            <form onSubmit={ onSubmitCreateExpenseCategory }>
                <Card>
                    <CardContent>
                    ...
                    <CardActions>
                        <SaveCancelButtons 
                            isLoading={ isLoading }
                            cancelBtnCallback={ () => history.push(PATH.INCOME_EXPENSE_CATEGORY) }
                            saveBtnCallback={ onSubmitCreateExpenseCategory }
                        />
                    </CardActions>
                </Card>
            </form>
...
export default connect(mapStateToProps, null)(CreateExpenseCategory)
