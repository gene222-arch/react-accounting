...
/** API */
import { findAsync } from '../../../../services/settings/salary.benefit';
...
const CreateSalaryBenefit = ({ alert, salaryBenefitProp, match }) => 
{
    ...
    const onLoadFetchBenefitById = async () => 
    {
        try {
    ...
    const onSubmitCreateSalaryBenefit = () => dispatch(SALARY_BENEFIT.updateSalaryBenefit(salaryBenefitState));

    useEffect(() => {
        onLoadFetchBenefitById();
    }, []);
