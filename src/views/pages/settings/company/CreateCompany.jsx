...
const CreateCompany = ({ alert, taxProp }) => 
{
    ...
    const onSubmitCreateTax = () => dispatch(TAX.createTax(taxState));
    ...
    return (
        <div>
            ...
            />
            <form onSubmit={ onSubmitCreateTax }>
                <Card>
                    <CardContent>
                    ...
                    <CardActions>
                        <SaveCancelButtons 
                            ...
                            saveBtnCallback={ onSubmitCreateTax }
                        />
                    </CardActions>
                </Card>
            </form>
...
export default connect(mapStateToProps, null)(CreateCompany)
